        ...
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600"><span class="font-medium">Payment Method:</span> {{ ucfirst(str_replace('_', ' ', $payment->method)) }}</p>
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-600 mb-4">We appreciate your business. Please sit tight and wait for your shipment!</p>
